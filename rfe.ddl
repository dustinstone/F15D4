...
ALTER TABLE F15D4_RFE_CONTACTS ADD CONSTRAINT F15D4_RFE_CONTACTS_PK PRIMARY KEY ( rfe_employee_id ) ;
...
ALTER TABLE F15D4_RFE_CONTACTS ADD CONSTRAINT FK_ASS_4 FOREIGN KEY ( employee_id ) REFERENCES F15D4_Employee ( employee_id ) ;

ALTER TABLE F15D4_RFE_CONTACTS ADD CONSTRAINT FK_ASS_5 FOREIGN KEY ( rfe_id ) REFERENCES F15D4_RFE ( rfe_id ) ;
